...
def main(mark, params=None):
    ...
    for epo in range(args.start_epoch, args.epochs):
        ...
        total_loss, labeled_losses, mc_losses, fd_loss, sim_sum, wrong_sum, sim_rate = train(
        ...
        fmtc = '[{}/{} | pl_sim: {} ({}/ {})] total_loss: {}, x_loss: {}, fd_loss: {}, mc_loss: {}'
...
def train(labeled_loader, model, model_ema, optimizer, scheduler, args):
    ...
    for batch_idx in range(args.eval_step):
        ...
        ms_logits_x, ms_features = [], []
        for stIdx in range(args.stream_num):
            ms_logits_x.append(ms_preds[stIdx])
            ms_features.append(ms_fs_p[stIdx])
        ...
        # region 2.5 multi-view features decorrelation loss
        if args.lambda_fd > 0:
        ...
        # region 2.6 pseudo max-correlation loss
        if args.lambda_mc > 0:
        ...
        loss = labeled_loss + args.lambda_fd * fd_loss + args.lambda_mc * mc_loss
    ...
    # endregion
    return total_loss_val, labeled_losses, mc_losses, fd_loss_val, sim_sum_val, wrong_sum_val, sim_rate_val
...
def init_args(params=None):
    ...
    # Model Setting
    parser.add_argument('--arch', default='WideResNet_MS', type=str, help='model name')
...
if __name__ == '__main__':
    dataset = "CIFAR10"
    main('E200_BS64_CBE_20240606.1', {'dataset': dataset, 'batch_size': 64})
