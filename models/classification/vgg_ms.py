...
def build_vgg_ms(vgg_type, num_classes, stream_num, noisy_factor, device):
    return VGG_MS(vgg_type, num_classes, stream_num, noisy_factor, device)
